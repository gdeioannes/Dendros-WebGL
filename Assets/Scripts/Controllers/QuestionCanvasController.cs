...
public class QuestionCanvasController : MonoBehaviour 
{
    ...
    private void loadData()
    {
		...
		string question = JsonController.jsonDataQuestions["stages"][ViewController._currentGameModel._missionNumber][0]["question"].ToString();
		this._questionText.text = question;
		this._answer1.text = JsonController.jsonDataQuestions["stages"][ViewController._currentGameModel._missionNumber][0]["options"][0].ToString();
		this._answer2.text = JsonController.jsonDataQuestions["stages"][ViewController._currentGameModel._missionNumber][0]["options"][1].ToString();
		
		answer = JsonController.jsonDataQuestions["stages"][ViewController._currentGameModel._missionNumber][0]["answer"].ToString();
    }
